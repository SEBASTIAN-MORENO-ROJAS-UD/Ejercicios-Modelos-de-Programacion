...
/**
 * Esta clase define las armas que son lanzas heredando los atributos y metodos de la clase abstracta Arma, invocando en su constructor el constructor de la superclase
...
public class Lanza extends Arma{
     ...
     */
    public Lanza(String nombre, String descripcion, String imagen){
